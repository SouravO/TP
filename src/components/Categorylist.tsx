...
export default function CategoryCards() {
  ...
  return (
    <>
      ...
      <div 
        ref={containerRef}
        className="h-screen bg-white flex items-center justify-between gap-10 p-10 font-bold uppercase tracking-tight z-[1000]"
      >
          ...
          {categories.map((cat, index) => (
            ...
            >
              ...
              <div
                ...
                className="mt-2 text-base text-blue-100"
