      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="footer-element text-xl md:text-2xl font-light opacity-70 mb-8">
            Ready to shape culture together?
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="footer-element text-center md:text-left">
            ...
            <p className="text-lg font-light">hello@tp-global.com</p>
          ...
          <div className="footer-element text-center md:text-right">
            <h3 className="text-sm letter-spaced mb-4 opacity-50">LOCATIONS</h3>
            <p className="text-lg font-light">Hong Kong • Dubai</p>
            <p className="text-lg font-light">Zurich • Amsterdam</p>
            <p className="text-lg font-light">Los Angeles • Shanghai</p>
          </div>
        </div>
        ...
        <div className="footer-element border-t border-border/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm opacity-50">
          <div className="mb-4 md:mb-0">
            <p>&copy; 2024 TP Global. All rights reserved.</p>
          </div>
