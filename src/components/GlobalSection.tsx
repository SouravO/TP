...
const GlobalSection = () => {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="space-y-8">
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 w-24 h-24 border border-primary/20 rounded-full animate-spin" style={{animationDuration: '15s'}}></div>
          </div>
          ...
          <p className="text-xl font-light opacity-70 max-w-3xl mx-auto leading-relaxed hover:opacity-100 transition-opacity duration-500 cursor-pointer">
            From Asia-Pacific to Europe and the Americas, we create experiences that transcend borders and connect cultures.
          </p>
          
          <div className="flex justify-center space-x-8 mt-12">
            {['ASIA', 'EUROPE', 'AMERICAS'].map((region, index) => (
